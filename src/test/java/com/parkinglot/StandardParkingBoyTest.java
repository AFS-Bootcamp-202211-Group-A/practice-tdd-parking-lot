...
public class StandardParkingBoyTest {
    ...
    @Test
    public void should_return_exception_with_error_message_when_fetch_given_a_standard_parking_boy_who_manage_two_parking_lots_and_a_used_parking_ticket() {
        // given
        ParkingLot firstParkingLot = new ParkingLot(1);
        ParkingLot secondParkingLot = new ParkingLot(1);
        List<ParkingLot> parkingLots = Stream.of(firstParkingLot, secondParkingLot).collect(Collectors.toList());
    ...
    @Test
    public void should_return_exception_with_error_message_when_park_given_a_standard_parking_boy_who_manage_two_parking_lots_both_without_any_position_and_a_car() {
        // given
        ParkingLot firstParkingLot = new ParkingLot(1);
        ...
        // when & then
        Exception exception = assertThrows(NoParkPositionException.class, () -> standardParkingBoy.park(car));
        assertEquals("No available position.", exception.getMessage());
    }
}
